...
ghdl -i --workdir=$WORK_DIR ../../unitFullAdder/src/FullAdder.vhd
ghdl -i --workdir=$WORK_DIR ../src/RippleCarryAdder.vhd
ghdl -i --workdir=$WORK_DIR ./tb_RippleCarryAdder.vhd

# building simulation files
ghdl -m --workdir=$WORK_DIR tb

# running the simulation
ghdl -r --workdir=$WORK_DIR tb --wave=$WORK_DIR/$WAVE_FILE --stop-time=10ms
